    ...
    <>
      ...
      <div className="container mt-5 fs-5 h-100">
        ...
        <ol className="mb-5">
          ...
          <li>
            If an employee does not achieve the target of 10 tests, a deduction
          ...
          <li>
            Monthly incentives will be granted based on performance in 10 tests,
        ...
        <p className="font-monospace text-danger">
