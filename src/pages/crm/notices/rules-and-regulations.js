    ...
    <>
      ...
      <div className="container mt-5 fs-5 h-100">
        ...
        <ol className='mb-5'>
          ...
          <li>Marketing employees will receive commissions every 4 months, solely based on regular clients' contributions (irregular or quarterly-based not applicable), such as ITS, WoodWood, THOD.</li>
